...
public class MpGeneratorUtil {
    ...
    private static String[] TABLENAME = {"tableName1","tableName2"};
    ...
    private static String DATABASE = "jdbc:mysql://127.0.0.1:3306/schemeName";       //数据库连接url
    private static String USERNAME = "xxx";                                        //账号
    ...
    private static String PARENT_PACKAGE = "com.shixin.xxx";            //基础包
    ...
    private static String ENTITY_FOLERNAME = "model";                //pojo类文件
